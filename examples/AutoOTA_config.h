#ifndef AUTO_OTA_CONFIG_H

#define AUTO_OTA_CONFIG_H

#include <Arduino.h>

// This is github Root CA, change to your server root CA if you are
// not using github for hosting the firmware binary
const char * serverRootCA = \
  "-----BEGIN CERTIFICATE-----\n"
